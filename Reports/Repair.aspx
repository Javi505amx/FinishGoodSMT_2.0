        ...
        <section class="container mt-3  mx-auto ">
            ...
            <div class="form-group mb-3 ">
                ...
                <div class="input-group ">
                    ...
                    <asp:LinkButton ID="QueryBtn" Visible="true" CssClass="btn btn-dark fw-bold " OnClick="QueryBtn_Click" runat="server" ToolTip="Click to enable query"><i runat="server" class="fa fa-search-plus"></i></asp:LinkButton>
