...
<head runat="server">
    ...
    <title>Workorder - Finish Good SMT</title>
</head>
<body >
...
<%--                        <asp:LinkButton runat="server" ID="btnHome" class=" btn btn-dark" title="Inicio -  Homepage" PostBackUrl="~/login.aspx" Text="Home">
            ...
            <span class="btn-label"><i  class="bi bi-box-arrow-right"></i></span> 
                    ...
                    <div class="navbar-nav mx-auto">
                        <a class="nav-link text-success fw-bold" href="#" title="">INGRESAR WORKORDER</a>
        ...
        <div class="container-fluid ">
            ...
            <div class="form-group row  py-2 position-absolute top-50 start-50 translate-middle w-75">
                <div class="input-field rounded-4  col-md-12 mx-auto text-center txtWorkOrderFinish">
                    ...
                    <asp:TextBox ID="txtWorkOrder" runat="server" type="text" AutoPostBack="true" CssClass="form-control-lg fs-1 text-center text-success" placeholder="Escanee workorder" OnTextChanged="txtWorkOrder_TextChanged" AutoCompleteType="Disabled"></asp:TextBox>
                </div>
            </div>
        </div>
    </form>
