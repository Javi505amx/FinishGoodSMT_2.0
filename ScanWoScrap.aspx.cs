...
{
    public partial class ScanWoScrap : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            userlabel.Text = Session["user"].ToString();
            txtWorkOrderScrap.Focus();
        }
        ...
        protected void txtWorkOrder_TextChanged(object sender, EventArgs e)
        {
            ...
            connection.Open();
            sqlCommand2.Parameters.Add("@WorkOrder", SqlDbType.VarChar, 50).Value = (object)txtWorkOrderScrap.Text.ToUpper();
            ...
            try
            {
                ...
                {
                    Response.Redirect("MainScrap.aspx");
                }
                else
                {
                    if (!(str2.Substring(0, 3) == "MX2"))
                        return;
                    Response.Redirect("ScrapScard.aspx");
                }
            }
            catch (Exception ex)
            {
                ...
                txtWorkOrderScrap.Text=string.Empty;
                txtWorkOrderScrap.Focus();
            }
        }
    }
