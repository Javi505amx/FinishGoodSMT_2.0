<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Users.aspx.cs" Inherits="FinishGoodSMT.test" %>
<!DOCTYPE html>
...
<head runat="server">
    ...
    <title>Finish Good SMT - Manage users</title>
</head>
<body>
        ...
        <nav class="navbar sticky-top navbar-expand-lg navbar-toggleable-sm navbar-dark bg-dark ">
            <div class="container-lg">
                ...
                <div class="collapse navbar-collapse  d-sm-inline-flex mx-auto">
                    <ul class="navbar-nav mx-auto">
                        <li>
                            <h4 style="text-align: center;" class=" text-white d-inline">ADMINISTRACIÓN DE USUARIOS FG SMT</h4>
                        </li>
                    </ul>
                </div>
            </div>
            <ul class=" navbar-collapse collapse navbar-nav">
                <li>
                    ...
                    <asp:LinkButton type="button" ID="logoutBtn" runat="server" class="btn btn-danger fw-bold" title=" del Sistema"><span runat="server" class=" fw-bold bi bi-box-arrow-left"></span></asp:LinkButton>
                </li>
            </ul>
        </nav>
                        ...
                        <div class="col-md">
                            <div class="form-floating">
                                <asp:DropDownList runat="server" ID="dataArea" DataTextField="Text" DataValueField="Value" CssClass="form-select col-md-4 text-primary fw-bold " aria-label="Floating label select example" AutoPostBack="false">
                                    ...
                                    <asp:ListItem Value="Planeacion">SMT</asp:ListItem>
