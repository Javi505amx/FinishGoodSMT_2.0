<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RepairScardValidation.aspx.cs" Inherits="FinishGoodSMT.RepairScardValidation" %>
...
<head runat="server">
    ...
    <title>Validacion - Reparación SCARD</title>
</head>
<body>
...
<span><i class="bi bi-cpu-fill fs-4  text-success fw-bold"></i> </span>
                        ...
                        <asp:LinkButton runat="server" ID="btnReparacion" class=" btn btn-dark border border-0" PostBackUrl="~/RepairScard.aspx" OnClientClick="if (!confirm('¿Está seguro que desea ir a REPARACION?')) return false;" Text="Módulo reparacion" ToolTip="Módulo reparacion">
<span><i class="bi bi-tools fs-4  text-warning fw-bold"></i> </span>
                        </asp:LinkButton>
                        <asp:LinkButton runat="server" ID="btnScrap" class=" btn btn-dark border border-0" OnClientClick="if (!confirm('¿Está seguro que desea ir al módulo de SCRAP?')) return false;" PostBackUrl="~/ScrapScard.aspx" Text="Módulo Scrap" ToolTip="Módulo Scrap">
<span><i class="bi bi-trash3-fill   text-danger fw-bold"></i> </span>
    ...
    <span class="btn-label"><i  class="bi bi-box-arrow-right"></i></span> 
                    ...
                    <div class="navbar-nav mx-auto">
                        <a class="nav-link text-primary fw-bold" href="#" title="">VALIDACION DE REPARACION SCARD</a>
                    </div>
        ...
        <div class="container ">
            <div class="row g-0">
                <div class="card  mt-2 p-0" runat="server">
                    <div class="card-header  text-center bg-dark text-white fw-bold fs-4  " runat="server" visible="true">VALIDAR REPARACIÓN SCARD</div>
                    <div class="card-body  text-center mt-4 p-0" runat="server">
                        <div class="input-field rounded-4 text-center mt-0" id="QR" runat="server" visible="true">
                            ...
                            <%--<asp:TextBox ID="txtWorkOrderQR" runat="server" type="text" AutoPostBack="true" CssClass="form-control fs-2 text-primary text-center" placeholder="Escanee Workorder" OnTextChanged="txtWorkOrder_TextChanged" AutoCompleteType="Disabled"></asp:TextBox>--%>
                            <asp:TextBox ID="txtWorkOrderQR" runat="server" AutoPostBack="true" CssClass="form-control fs-2 text-primary text-center" placeholder="Escanee Workorder" OnTextChanged="txtWorkOrder_TextChanged" AutoCompleteType="Disabled"></asp:TextBox>
                        ...
                        <div class="  form-group mt-0 p-3  ">
                            ...
                            <asp:LinkButton CssClass="btn btn-dark fw-bold" ID="btnResetAll" runat="server" Visible="true" OnClick="btnResetAll_Click" OnClientClick="if (!confirm('¿Está segur@ de que desea buscar otra workorder?')) return false;"><span class="bi bi-arrow-repeat fw-bold"></span>  Buscar otra workorder? </asp:LinkButton>
                            ...
                            <div class="rounded table-responsive ">
                                <asp:GridView runat="server" ID="myTable" OnRowDataBound="myTable_RowDataBound" OnRowCommand="myTable_RowCommand" HeaderStyle-HorizontalAlign="Center" OnPageIndexChanging="myTable_PageIndexChanging" OnSelectedIndexChanged="myTable_SelectedIndexChanged" CssClass="table table-sm  table-hover table-bordered " ShowHeaderWhenEmpty="false" AutoGenerateColumns="false" DataKeyNames="WorkOrder" AllowPaging="false" BorderStyle="None" Visible="true">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="WorkOrder" HeaderText="WorkOrder" ItemStyle-Width="15%" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center"></asp:BoundField>

                                        <asp:BoundField DataField="Model" HeaderText="Model" ItemStyle-Width="15%" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center"></asp:BoundField>
                                        <asp:BoundField DataField="Pieces" HeaderText="Pieces" ItemStyle-Width="6%" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center"></asp:BoundField>
                                        <asp:BoundField DataField="Status" HeaderText="Status" ItemStyle-Width="4%" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center"></asp:BoundField>
                                        <asp:BoundField DataField="UserScan" HeaderText="Registró" ItemStyle-Width="5%" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center"></asp:BoundField>
                                        <asp:BoundField DataField="ScanDate" HeaderText="Fecha" ItemStyle-Width="8%" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center"></asp:BoundField>
