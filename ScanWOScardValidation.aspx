<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScanWOScardValidation.aspx.cs" Inherits="FinishGoodSMT.ScanWOScardValidation" %>
...
<head runat="server">
    ...
    <meta name="description" title="Workorder  - Validacion SCARD" />
    ...
    <title>Workorder  - Validacion SCARD</title>
</head>
<body>
       ...
       <nav class="navbar sticky-top navbar-expand-lg  navbar-dark bg-dark">
           ...
           <span class="btn-label"><i  class="bi bi-box-arrow-right"></i></span> 
                   ...
                   <div class="navbar-nav mx-auto">
                       <a class="nav-link text-primary fw-bold" href="#" title="">INGRESAR WORKORDER</a>
       ...
       <div class="container-fluid ">
           ...
           <div class="form-group row  py-2 position-absolute top-50 start-50 translate-middle w-75">
               <div class="input-field rounded-4  col-md-12 mx-auto text-center txtWorkOrderRepair">
                   <span class="bi bi-tools p-2 text-primary"></span>

                   <%--<asp:Label ID="lblWorkOrder" for="txtWorkOrder" runat="server" Text="INGRESAR WORKORDER" CssClass="form-label fs-1"></asp:Label>--%>
                   <asp:TextBox ID="txtWorkOrdeValidation" runat="server" type="text" AutoPostBack="true" CssClass="form-control-lg fs-1 text-center text-primary" placeholder="Escanee workorder" OnTextChanged="txtWorkOrdeValidation_TextChanged" AutoCompleteType="Disabled"></asp:TextBox>
