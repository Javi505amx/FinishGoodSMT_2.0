...
{
    public partial class ScrapScard : System.Web.UI.Page
    {
        ...
        protected void txtQty_TextChanged1(object sender, EventArgs e)
        {
            ...
            //if (str2.ToString() == txtQRMain.Text.ToString())
            {
                ...
                if (Convert.ToInt32(txtQty.Text) <= pieces)
                {
                    ...
                    SqlCommand sqlCommand3 = new SqlCommand("AddScardScrap", connection2);
        ...
        private void dataBindInfoWO()
        {
            ...
            SqlCommand sqlCommand1 = new SqlCommand("GetInfoWoCountScard", connection1);
