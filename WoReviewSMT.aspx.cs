...
{
    public partial class WoReviewSMT : System.Web.UI.Page
    {
        ...
        private void ExportGridToExcel()
        {
            ...
            Response.Charset = "";
            string FileName = "Finish Good SMT WO Review " + "_" + DateTime.Now + ".xls";
        ...
        private void BindGridView()
        {
            ...
            {
                SqlCommand sqlCommand = new SqlCommand("GetScanHistoricWO", sqlConnectionData)
                {
        ...
        private void BindGridView2()
        {
            ...
            SqlConnection sqlConnectionData = new SqlConnection(connection);
            {
                SqlCommand sqlCommand = new SqlCommand("GetScanHistoric", sqlConnectionData)
                {
                    CommandType = CommandType.StoredProcedure
                };
                sqlConnectionData.Open();
